OC.L10N.register(
    ...
    "Each rule group consists of one or more rules. A request matches a group if all rules evaluate to true. On creating or writing a file all defined groups are evaluated and when matching, a background job is set up to execute the conversion of the corresponding file." : "Erregela talde bat erregela bat edo gehiagoz osatua dago. Eskaera bat talde batekoa izango da erregela guztiak egia badira. Fitxategiak sortu edo idaztean talde guztiak ebaluatzen dira eta egokia topatzen bada, atzeko planoko ataza exekutatuko da dagokion fitxategia bihurtzeko.",
    "Document to PDF converter" : "Dokumentutik PDFrako bihurtzailea"
},
